...
A simple web app which returns a static page with the release name
...
| image.repository | string | `"us-docker.pkg.dev/google-samples/containers/gke/whereami"` |  |
| image.tag | string | `"v1.2.20"` |  |
