...
Common labels
*/}}
{{- define "guard-helm.labels" -}}
helm.sh/chart: {{ include "guard-helm.chart" . }}
{{ include "guard-helm.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "guard-helm.selectorLabels" -}}
app.kubernetes.io/name: {{ include "guard-helm.name" . }}
